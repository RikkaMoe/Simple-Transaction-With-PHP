...
date_default_timezone_set('Asia/Jakarta');
   ...
   $kodep = $_POST['kode'];
   $nasabahp = $_POST['nasabah'];
   $saldop = $_POST['saldo'];
   $waktu = date('Y-m-d  h:i:s');
   $tarikp = 0;

  if (empty($kodep) || empty($nasabahp) || empty($saldop))
  {
    echo " <script>alert('Gagal, Data tidak lengkap'); </script> ";
  }
  else {
    $perintah = "INSERT INTO rekening (id_rekening, id_nasabah, saldo) VALUES ('$kodep', '$nasabahp', '$saldop')";
    $perintah2 = "INSERT INTO transaksi (tanggal, id_rekening, setor, tarik) VALUES ('$waktu', '$kodep', '$saldop', '$tarikp')";
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form method="post" role="form" class="php-email-form">
              <div class="form-group">
                <input type="text" name="kode" class="form-control" data-rule="minlen:4" value="<?php echo randomString(10); ?>" readonly/>
              ...
              <div class="form-group">
                <select name="nasabah" class="form-control">
                  ...
                  <?php 
                    include '../koneksi.php'; 
                    $perintah="SELECT * FROM nasabah";
                    $query=mysqli_query($conn,$perintah);
                    while($data=mysqli_fetch_array($query))
                    {
                  ?>
                    <option value="<?php echo $data['id_nasabah'] ?>">
                        <?php echo $data['id_nasabah']?> | <?php echo $data['nama_nasabah'] ?>
                    </option>
                  <?php
                    }
                  ?>
              ...
              <div class="form-group">
                <div class="input-group flex-nowrap">
                  ...
                  <input type="text" class="form-control" name="saldo" placeholder="Saldo Anda"data-msg="Tolong isi saldo anda" autocomplete="off" data-rule="minlen:4" aria-describedby="addon-wrapping"/>
                  <div class="validate"></div>
                </div>
              </div>
