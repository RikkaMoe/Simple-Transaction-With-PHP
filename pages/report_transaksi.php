            ...
            <table class="table">
              <tbody>
                <tr style="background-color: #CAC2C1">
                  <td scope="col" align="center"><b>Tanggal</b></td>
                  <td scope="col" align="center"><b>Setor</b></td>
                  <td scope="col" align="center"><b>Tarik</b></td>
                </tr>
              <?php
                include '../koneksi.php';
                $get_id = $_GET['rek'];
                $perintah = "SELECT * FROM transaksi WHERE id_rekening = '$get_id'";
              ...
              ?>
                <tr>
                  ...
                  <td align="center"><?php echo rupiah($data['setor']) ?></td>
                  <td align="center"><?php echo rupiah($data['tarik']) ?></td>
                </tr>
              <?php
                }
                include '../koneksi.php';
                $get_id = $_GET['rek'];
                $perintah2 = "SELECT * FROM rekening WHERE id_rekening = '$get_id'";
              ...
              ?>
                <tr>
                  ...
                  <td align="center" colspan="2"><?php echo rupiah($data2['saldo']) ?></td>
                </tr>
              <?php
                }
              ?>
