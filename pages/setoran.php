...
date_default_timezone_set('Asia/Jakarta');
  ...
  $rekp = $_POST['rek'];
  $setoranp = $_POST['setoran'];
  $waktu = date('Y-m-d  h:i:s');
  $tarikp = 0;

  if (empty($rekp) || empty($setoranp))
  {
    echo " <script>alert('Gagal, Data tidak lengkap'); </script> ";
  }
  else {
    $perintah = "UPDATE rekening SET saldo = saldo + '$setoranp' WHERE id_rekening = '$rekp'";
    $perintah2 = "INSERT INTO transaksi (tanggal, id_rekening, setor, tarik) VALUES ('$waktu', '$rekp', '$setoranp', '$tarikp')";
            ...
            <form method="post" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <div class="input-group flex-nowrap">
                  ...
                  <input type="text" class="form-control" name="setoran" placeholder="Setoran anda"data-msg="Tolong isi setoran anda" autocomplete="off" data-rule="minlen:4" aria-describedby="addon-wrapping"/>
